...
import ru.cft.shiftlab.gorin.market.exceptions.SavingRecordException;
...
public class AddProductController {
    ...
    /**
     * Метод, обрабатывающий Post-запрос, который отправляет MonitorDTO. Метод передает его сервису по добавлению товаров
    ...
    public ResponseEntity<?> addMonitor(@RequestBody MonitorFeaturesDTO monitorFeaturesDTO) {
        ...
        String response = "The id of saved monitor is: " + id;
        logger.info(response);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    /**
     * Метод, обрабатывающий Post-запрос, который отправляет HddDTO. Метод передает его сервису по добавлению товаров
    ...
    public ResponseEntity<?> addHdd(@RequestBody HddFeaturesDTO hddFeaturesDTO) {
        ...
        String response = "The id of saved hdd is: " + id;
        logger.info(response);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    /**
     * Метод, обрабатывающий Post-запрос, который отправляет LaptopDTO. Метод передает его сервису по добавлению товаров
    ...
    public ResponseEntity<?> addLaptop(@RequestBody LaptopFeaturesDTO laptopFeaturesDTO) {
        ...
        String response = "The id of saved laptop is: " + id;
        logger.info(response);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    /**
     * Метод, обрабатывающий Post-запрос, который отправляет PcDTO. Метод передает его сервису по добавлению товаров
    ...
    public ResponseEntity<?> addPc(@RequestBody PcFeaturesDTO pcFeaturesDTO) {
        ...
        String response = "The id of saved pc is: " + id;
        logger.info(response);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
